---
{"dg-publish":true,"permalink":"/tags/muse-tags/dragon-age/haleir-lavellan/tags-haleir/","tags":["muse-tags","muse-haleir","tags-haleir"],"dg-note-properties":{"tags":["muse-tags","muse-haleir","tags-haleir"],"aliases":["Tags - Haleir Lavellan"]}}
---

# In Character

```
IC ☾⭒ A Quantum Leap From Imagining, IC ☾⭒ Haleir Lavellan, 
```
...
```
 Haleir ☾⭒ Dragon Age ( Dragon Age )
```
#### 0.1 Dragon Age Timeline (Series Canon)
```
 Haleir ☾⭒ 9:50 - 9:54 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:45 - 9:49 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:40 - 9:44 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:35 - 9:39 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:30 - 9:34 Dragon ( Dragon Age )
```
##### 0.1a Dragon Age Timeline (Pre-Canon)
```
 Haleir ☾⭒ 9:25 - 9:29 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:20 - 9:24 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:15 - 9:19 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:10 - 9:14 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:05 - 9:09 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:00 - 9:04 Dragon ( Dragon Age )
```
##### 0.1b Dragon Age Timeline (Post-Canon)
```
 Haleir ☾⭒ 9:95 - 9:99 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:90 - 9:94 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:85 - 9:89 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:80 - 9:84 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:75 - 9:79 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:70 - 9:74 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:65 - 9:69 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:60 - 9:64 Dragon ( Dragon Age )
 Haleir ☾⭒ 9:55 - 9:59 Dragon ( Dragon Age )
```
...
```
Haleir ☾⭒ Scion Of The Outer Planes — Alt Universe ( Baldur's Gate )
```

#### 2 BG.2 Astral Drifter
```
Haleir ☾⭒ Astral Drifter — Alt Universe ( Baldur's Gate )
```

### Dragon Age
#### 2 DA.1 Verse
```
Haleir ☾⭒ QuickID — Alt Universe ( Dragon Age )
```

### Mass Effect
#### 2 ME.1 Verse
```
Haleir ☾⭒ QuickID — Alt Universe ( Mass Effect )
```
...
```
Haleir ☾⭒ One Big Continuity Error — Alt Universe ( Doctor Who )
```

#### Elder Scrolls
##### 2 ES.1 Verse
```
Haleir ☾⭒ QuickID — Alt Universe ( Elder Scrolls )
```

#### Stardew Valley
##### 2 SV.1 Verse
```
Haleir ☾⭒ QuickID — Alt Universe ( Stardew Valley )
```
...
```
Haleir ☾⭒ Absolute Crisis — Another World ( Baldur's Gate )
```

#### 3 BG.1 Planar Agent
```
Haleir ☾⭒ Planar Agent — Another World ( Baldur's Gate )
```

### Dragon Age
#### 3 DA.1 This Shit Is Weird
```
Haleir ☾⭒ This Shit Is Weird — Another World ( Dragon Age )
```

### Mass Effect
#### 3 ME.1 Anomaly Detected
```
Haleir ☾⭒ Anomaly Detected — Another World ( Mass Effect )
```
...
```
Haleir ☾⭒ Previously—Next Time — Another World ( Doctor Who )
```

#### Elder Scrolls
##### 3 ES.1 Verse
```
Haleir ☾⭒ QuickID — Another World ( Elder Scrolls )
```

#### Stardew Valley
##### 3 SV.1 Verse
```
Haleir ☾⭒ QuickID — Another World ( Stardew Valley )
```
...
```
Haleir ☾⭒ Planar Wanderer — Another World ( Multiverse )
```

### 4.2 Eluvian Explorer (Dragon Age)
```
Haleir ☾⭒ Eluvian Explorer — Another World ( Multiverse )
```

### 4.3 Crucible BS (Mass Effect)
```
Haleir ☾⭒ Crucible BS — Another World ( Multiverse )
```
...
### PartnerURL - PartnerHaleir
#### 5.1 Verse
```
Haleir ☾⭒ QuickID ( Partner — PartnerURL )
```
