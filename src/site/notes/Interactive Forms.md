...
## Permanent Starter Call (With Benefits)
*A* **permanent starter call** *with benefits — including permanent inbox, plotting, shipping, etc. calls.* **This is where my Mains come from.**

> [!example]- Form - Permanent Interactions Call
...
> 
> | Condition | Fill Out Form|
> |---|---|
> | Have Not Read Restrictions | No - *Read Those First!* |
...
> [!example]- Form - Permanent Interactions Call (Same Form As Found Above!!)
> <iframe data-tally-src="https://tally.so/embed/eqraq0?alignLeft=1&hideTitle=1&dynamicHeight=1" loading="lazy" width="100%" height="7660" frameborder="0" marginheight="0" marginwidth="0" title="Permanent Interactions Call - QS"></iframe>
> <script>var d=document,w="https://tally.so/widgets/embed.js",v=function(){"undefined"!=typeof Tally?Tally.loadEmbeds():d.querySelectorAll("iframe[data-tally-src]:not([src])").forEach((function(e){e.src=e.dataset.tallySrc}))};if("undefined"!=typeof Tally)v();else if(d.querySelector('script[src="'+w+'"]')==null){var s=d.createElement("script");s.src=w,s.onload=v,s.onerror=v,d.body.appendChild(s);}</script>

## Multi-Muses Interest Tracker
*For those with multimuse blogs and/or multiple single muse blogs only.*
